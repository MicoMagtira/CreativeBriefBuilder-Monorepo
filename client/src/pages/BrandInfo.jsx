            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mt-6">
                ...
                <p className="mt-2 text-sm text-amber-600 flex items-start">
                  ...
                  These products will appear in the "<span className="font-medium">Product List</span>" section of your brief. Adding products here gives you full control over what appears in your brief.
                </p>
              </div>
